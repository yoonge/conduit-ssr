export default (pathname: string, pageSize: number, total: number, current: number) => {
  ...
  if (totalPage === 1) {
    ...
    1 === current
      ...
      : pageList += `<li class="page-item"><a class="page-link" href="${pathname}?page=${current}&d=prev">Previous</a></li>`
    ...
    totalPage === current
      ...
      : pageList += `<li class="page-item"><a class="page-link" href="${pathname}?page=${current}&d=next">Next</a></li>`
    return pageList
    ...
    if (current <= 5) {
      ...
      pageList += `
          ...
          <li class="page-item"><a class="page-link" href="${pathname}?page=${current}&d=next">Next</a></li>
        `
      return pageList
